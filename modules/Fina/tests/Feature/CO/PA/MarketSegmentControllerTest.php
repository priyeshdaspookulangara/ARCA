...
class MarketSegmentControllerTest extends TestCase
{
    ...
    public function test_can_create_market_segment()
    {
        $data = [
            ...
            'description' => 'This is a test market segment.',
        ];
    ...
    public function test_can_get_market_segment()
    {
    ...
    public function test_can_update_market_segment()
    {
        ...
        $data = [
            'name' => 'Updated Market Segment',
            'description' => 'This is an updated market segment.',
        ];

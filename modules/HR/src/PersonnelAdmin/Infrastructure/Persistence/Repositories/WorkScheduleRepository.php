...
use Modules\HR\Models\EmployeeWorkSchedule;
use Modules\HR\PersonnelAdmin\Domain\Repositories\WorkScheduleRepositoryInterface;
use Carbon\Carbon;
...
class WorkScheduleRepository implements WorkScheduleRepositoryInterface
{
    public function findCurrentByEmployeeId(int $employeeId, string $date = 'today')
    {
        ...
        return EmployeeWorkSchedule::where('employee_id', $employeeId)
